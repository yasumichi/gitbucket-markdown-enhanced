(function () {
    ...
    gme.renderer = new marked.Renderer();
     ...
     */
    gme.renderer.code = (code, language) => {
        var html = "";
    ...
    gme.tokenizer = new marked.Tokenizer();

    /**
     * Disable default strikethrough in Marked 
     */
    gme.tokenizer.del = (src) => {
        return false;
    };
